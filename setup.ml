...
(* OASIS_START *)
(* DO NOT EDIT (digest: ea04615cdce14046620ec63c7d26650d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "store abstraction over irmin for PIH data store instances";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("irmin.mirage", None);
                           FindlibPackage ("irmin.http", None);
                           FindlibPackage ("conduit", None);
                           FindlibPackage ("conduit.mirage", None);
                           FindlibPackage ("mirage-http", None);
                   ...
                   {
                      lib_modules = ["Data_store"];
                      lib_pack = false;
                      lib_internal_modules = ["Inflator"; "Base_store"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pih-store";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\234\145\185\226 Xv\144@\155\135\145\231y\128\228";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
